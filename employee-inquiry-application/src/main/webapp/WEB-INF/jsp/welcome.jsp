...
<html lang="en">
<head>
  <title>HCL Employee Inquiry</title>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#"><B>HCL Employee Inquiry </B></a>
    </div>
      <ul class="nav navbar-nav navbar-right">
        <li> 
	          <div id="getEmployees" class="form-inline" > 
		        <form:form action="https://employee-auth-service-dev.apps.nonprod.apprd01.uk.hclcnlabs.com/oauth/authorize" method="post">
	                <input type="hidden" name="response_type" value="code" /> 
	                <input type="hidden" name="client_id" value="employeeapp" />
	                <input type="hidden" name="redirect_uri" value="https://employee-inquiry-application-dev.apps.nonprod.apprd01.uk.hclcnlabs.com/index" />
	               <!--   <input type="hidden" name="redirect_uri" value="http://localhost:8082/index" /> -->
	                <input type="hidden" name="scope" value="read" /> 
	                <input type="SUBMIT" class="btn btn-info" value="Authorized Employee" style="font-weight: bold;margin-top:10px;margin-right:10px;padding-top:5px;"/>
		        </form:form>
	    	</div>
    	</li>
    </ul>
...
<div class="container-fluid text-center">    
  ...
  <div class="col-sm-2 sidenav">
    ...
    <div class="col-sm-8 text-justify"> 
      ...
      <hr>
      <img src="${pageContext.request.contextPath}/images/architecture.jpg" width="100%" height="400"  alt="Responsive image">
      </div>
 <div class="col-sm-2 sidenav">
</div>      
  </div> 
