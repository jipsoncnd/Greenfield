  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <ul class="nav navbar-nav">
        ...
        <li><a target="_blank" href="https://employee-master-service-dev.apps.nonprod.apprd01.uk.hclcnlabs.com/hystrix/monitor?stream=https://employee-master-service-dev.cfapps.io/actuator/hystrix.stream">Hystrix DashBoard</a></li>
        <li><a target="_blank" href="https://employee-master-service-dev.apps.nonprod.apprd01.uk.hclcnlabs.com/swagger-ui.html">Swagger Documentation</a></li>
